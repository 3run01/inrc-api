...
var _nivel1 = require('../../controllers/nivel1');
...
router.get('//imagem',  verifyJWT, _imagens.fotos);
router.post('//imagem',  verifyJWT, _imagens.fotos);
/**                                                   */ 
router.post('//nivel1', _nivel1.nivel1);
router.post('/sic/api/v1/detalhada/nivel1', _nivel1.nivel1);
/**                                                   */ 
